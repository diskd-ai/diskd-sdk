...
export type MessageParams = {
  ...
  readonly turnContextJson?: string;
  readonly functionCall?: JsonObject;
...
const inferParticipantKind = (role: string): string => {
...
export const buildMessage = (params: MessageParams): DriveSessionMessage => ({
...
const emptyConfig: DriveSessionConfig = {
  operativeId: null,
  provider: null,
  model: null,
  promptText: null,
