...
// -- Tools: BI query, inodes query, Telegram search, inode-ls --
...
export type DriveToolsInodeLsParams = {
  readonly path?: string;
...
export type DriveIndexerStartParams = {
  readonly path: string;
};

export type DriveIndexerStartResult = {
  readonly success: boolean;
  readonly jobId: string;
};

export type DriveIndexerStopParams = {
  readonly jobId: string;
};

export type DriveIndexerStopResult = {
  readonly success: boolean;
};

export type DriveIndexerStatusParams = {
  readonly jobId: string;
};

export type DriveIndexerStatusResult = {
  readonly jobId: string;
...
export type DriveIndexerStatusBatchParams = {
  readonly jobIds: readonly string[];
};

export type DriveIndexerStatusBatchResult = {
  readonly statuses: readonly DriveIndexerStatusResult[];
};

export type DriveIndexerListParams = {
  readonly status?: string;
  readonly limit?: number;
};

export type DriveIndexerListResult = {
  readonly jobs: readonly Readonly<Record<string, unknown>>[];
};

// -- Upload: web URL, Telegram entity --

export type DriveUploadWebUrlParams = {
  readonly url: string;
  readonly parentPath?: string;
  readonly name?: string;
  readonly scrapeDepth?: number;
  readonly scrapeTimeout?: number;
  readonly scrapeDelay?: number;
  readonly scrapeRetries?: number;
};

export type DriveUploadWebUrlResult = {
  readonly id: string;
...
export type DriveUploadTgEntityParams = {
  readonly entityId: string;
  readonly parentPath?: string;
  readonly name?: string;
};

export type DriveUploadTgEntityResult = {
  readonly id: string;
  readonly parentId: string;
  readonly etag: string;
  readonly version: number;
